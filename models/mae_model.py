...
from models.model_utils import get_2d_sincos_pos_embed, get_plugin, register_plugin
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, norm_pix_loss=False, pos_encode_weight = 1.0):
        super().__init__()
